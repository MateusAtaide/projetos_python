...
layout = [[sg.Text('Olá Mundo!')],#adiciona um texto a 1ª linha
        ...
        #adiciona um texto e uma caixa de input na 2ª linha, já com um texto padrão

        [sg.Text('Arquivo:'), sg.Input(), sg.FileBrowse()],
        #adiciona texto, caixa de input e um buscador de arquivos na 3ª linha
